...
import type {BrowserFactory as BrowserFactoryInterface, BrowserService as BrowserServiceInterface, PageFactory as PageFactoryInterface, PageService as PageServiceInterface, Context as ContextInterface} from "./modules/playwright/types.js";
...
import {PageFactory} from "./modules/playwright/PageFactory.js";
import {PageService} from "./modules/playwright/PageService.js";
...
container.bind<PageFactoryInterface>(dependencies.PageFactory).to(PageFactory);
container.bind<PageServiceInterface>(dependencies.PageService).to(PageService);
